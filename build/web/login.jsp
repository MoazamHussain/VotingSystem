<%-- 
    Document   : login
    Created on : Mar 1, 2020, 5:11:24 PM
    Author     : Moazam
--%>
    ...
    <div class="container">
      ...
      <div class="content" style="background-image:url('img/login.jpeg')">
        ...
        <div class="row">
          <div class="span14">
						<div>
							<form action="validatevoter.jsp">
								<div class="clearfix">
									<label for="ssn">Voter ID</label>
									<div class="input">
										<input type="number" name="adhaar" maxlength="13" autocomplete="off">
									</div>
								</div>
								<div class="clearfix">
									<label for="sent1">User Name</label>
									<div class="input">
                                                                            <input type="text" name="username" maxlength="13" autocomplete="off">
									</div>
								</div>
								<div class="clearfix">
									<label for="sent2">Password</label>
									<div class="input">
										<input type="Password" name="password" maxlength="13" autocomplete="off">
									</div>
								</div>
