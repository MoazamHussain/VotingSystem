...
">
  ...
  String sql="select * from voter where party<>' '";
  String sql1="select * from voter where party=''";
  String sql2="select count(*) as rown from voter where party=' '";
  String sql3="select count(*) as rowv from voter where party<>' '";
...
while(rs.next()) 
{
  ...
  <tr>
            ...
            <td><b><font color="green">Given</font><b></td>
          </tr>
...
while(rs1.next()) 
{
  ...
  <tr>
            ...
            <td><b><font color="red">Not Given</font><b></td>
          </tr>
...
<div class="col-lg-6" style="text-align:center;padding-left: 130px;">
                 <h6 style="color:black">Total Number of votes given :<font color="green"><b><%=v%></b></font></h6>
                 <h6 style="color:black">Total Number of votes not given : <font color="red"><b><%=nonv%></b></font></h6>
                <div id="piechart"></div>
...
function drawChart() {
  ...
  <form action="genvotes.jsp">
      <br>
      <br>
      <input type="submit" value=" N E X T" class="btn success">
  </form>
